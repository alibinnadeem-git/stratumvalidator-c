export type LifecycleEventType='REGISTER_ASSET'|'PROCURE'|'SHIP'|'TRANSFER_CUSTODY'|'RECEIVE'|'INSTALL'|'INSPECT'|'TEST'|'COMMISSION'|'ENERGIZE'|'MAINTAIN'|'REPAIR'|'REPLACE'|'DECOMMISSION'|'AUDIT_ROOT';
